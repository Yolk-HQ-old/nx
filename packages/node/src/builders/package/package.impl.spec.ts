...
import { MockBuilderContext } from '@yolkai/nx-workspace/testing';
...
jest.mock('@yolkai/nx-workspace/src/utils/fileutils');
let fsUtility = require('@yolkai/nx-workspace/src/utils/fileutils');
