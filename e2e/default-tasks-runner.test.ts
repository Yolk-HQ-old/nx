  ...
  describe('defaultTasksRunner', () => {
    describe('Parallel', () => {
      it('should be able to run tasks in parallel', () => {
        ...
        runCLI(`generate @yolkai/nx-workspace:lib ${mylib1}`);
        runCLI(`generate @yolkai/nx-workspace:lib ${mylib2}`);
    ...
    describe('Cache', () => {
      it('should not use cache when it is not enabled', async () => {
        ...
        runCLI(`generate @yolkai/nx-web:app ${myapp1}`);
        runCLI(`generate @yolkai/nx-web:app ${myapp2}`);
        ...
        updateFile('nx.json', c => {
          ...
          nxJson.tasksRunnerOptions = {
            default: {
              runner: '@yolkai/nx-workspace/src/tasks-runner/tasks-runner-v2',
              options: {
