...
Running `nx g @yolkai/nx-react:application frontend` will create:
...
By default, Nx uses Jest for both React and Node.js applications. So if you run `nx g @yolkai/nx-react:app frontend`, you will get:
